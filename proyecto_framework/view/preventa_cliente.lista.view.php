                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <div class="row">
                                            Cliente
                                            <input type="text" id="persona_id" value="<?php echo $id_usuario; ?>"
                                                   class="form-control" style="display:none" >
                                            <input type="text" id="cliente_name" class="form-control"  value="<?php echo $nombreUsuario;  ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                                        <ul class="nav navbar-right panel_toolbox">
        ...
        <script src="js/preventa_cliente.listar.js" type="text/javascript"></script>
