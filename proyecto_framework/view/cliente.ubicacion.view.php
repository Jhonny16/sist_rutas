...
<!--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAFwfIZwaZScoGf8kJqRbVGjmUXDYdnyHY&libraries=places&callback=initAutocomplete"-->
    ...
    <body class="nav-md">
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBMRPFhDPdV7pmRcaaF_ExS1AL-lP3IM6A&libraries=places&callback=mapa_direcciones" async defer></script>
