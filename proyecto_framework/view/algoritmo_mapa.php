                        ...
                        <div class="row">       
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <p>
                                            Desde: <input type="date"  id="fecha1_ruta"                                                            value="<?php
                                                          date_default_timezone_set("America/Lima");
                                                          echo date('Y-m-d');
                                                          ?>">
                                            Hasta: <input type="date"  id="fecha2_ruta"  class=""
                                                          value="<?php
                                                          date_default_timezone_set("America/Lima");
                                                          echo date('Y-m-d');
                                                          ?>">
                                            <button type="button" class="btn btn-success" id="btn_buscar_list_pv"  onclick="busqueda_rutas()"> Buscar<i class="fa fa-search"></i></button>
...
<!--                                                                                </div>-->
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" onclick="actualizar_entrega_2();" class="btn btn-success" aria-hidden="true">Actualizar</button>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBMRPFhDPdV7pmRcaaF_ExS1AL-lP3IM6A&libraries=places&callback=init_mapa" async defer></script>
