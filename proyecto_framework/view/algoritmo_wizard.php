                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="x_panel" style="height: 200px">
                                                            <div class="x_title">
                                                                ...
                                                                <ul class="nav navbar-right panel_toolbox">
<!--                                                                    <button type="button" class="btn btn-warning btn-sm" onclick="limpiar_tabla()"><i class="fa fa-trash"></i> Limpiar Todo</button>-->
                                            ...
                                            <div id="step-3" style="height: 400px">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <p><label for="">Costo x Galón</label><input class="form-control" type="number" id="num_costo" style="width: 90px"
                                                                   value="0.0"
                                                            onkeypress=""></p>
