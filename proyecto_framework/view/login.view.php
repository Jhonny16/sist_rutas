...
<html>
    ...
    <body class="login" style="background: url('../images/fondito2.jpg');">
        <div>
            <a class="hiddenanchor" id="signup"></a>
            <div class="login_wrapper" >
                <div class="animate form login_form" style='border-radius: 15px ;
                     background-image: linear-gradient(154deg, rgb(29,118,208) 0px,rgb(42,63,84) 100%);'>
                    <section class="login_content">
                        <form action="../controller/sesion.validar.controller.php" method="post" >
                            ...
                            <div class="separator">
                                ...
                                <div>
                                    <h1><img src="../images/logitoa.png" style="width: 1.5em; height: 1.5em">lvarez  |
                                        <img src="../images/imageb.png" style="width: 1.5em; height: 1.5em">ohl</h1>
                                    <p>©2018 </p>
                                </div>
                            </div>
                        </form>
