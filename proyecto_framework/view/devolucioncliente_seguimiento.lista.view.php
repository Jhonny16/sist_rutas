                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <div class="row">
                                            Cliente
                                            <input type="text" id="devpersona_id" value="<?php echo $id_usuario; ?>"
                                                   class="form-control" style="display:none" >
                                            <input type="text" id="devcliente_name" class="form-control"  value="<?php echo $nombreUsuario;  ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                                            <button type="button" class="btn btn-success btn-sm" id="btn_new_pv"><i class="fa fa-copy"></i> Nueva Pre-venta</button>  -->
        ...
        <script src="js/devolucioncliente_list.js" type="text/javascript"></script>
