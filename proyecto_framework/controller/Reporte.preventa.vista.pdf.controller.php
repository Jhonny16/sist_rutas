...
$htmlReporte = Help::generarHTMLReporte2(utf8_encode($htmlDatos), $usuario, $fecha1, $fecha2, $titulo, $zona_name, $val_estado);
Help::generarReporte($htmlReporte, 2, "Reporte_preventas");
