...
$htmlReporte = Help::generarHTMLReporte3(utf8_encode($htmlDatos), $usuario, $fecha1, $fecha2, $titulo, $zona_name);
Help::generarReporte($htmlReporte, 2, "Reporte_clienteone_pedido");
