...
class Help {
                    ...
                    <html>
                        <head>
                            ...
                            <table width="100%">
                                    <head>
                                        <tr>
                                            <th><img src="../images/logitoa.png" style="width:1em;height: 1em">lvarez 
                                            <img src="../images/imageb.png" style="width:1em;height: 1em">ohl</th>
    ...
    public static function generaPDF($file = '', $html = '', $paper = 'a4', $download = true) {
        ...
        //$font = Font_Metrics::get_font("Arial", "bold");
        //$file->page_text(765, 550, "Pagina {PAGE_NUM} de {PAGE_COUNT}", $font, 9, array(0, 0, 0));
