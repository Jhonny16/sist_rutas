...
class Ruta extends Conexion {
    ...
    public function save_ruta($id_punto_inicio, $id_punto_final) {
        ...
        try {
            ...
            $nodos_intermedios = json_decode($this->nintermedios);
    ...
    public function lista($fecha1, $fecha2, $tipo_usuario, $usuario) {
        ...
        try {
            if($tipo_usuario == 7){
               ...
               x.apellidos ||' '|| x.nombres as chofer, 
                ...
                inner join usuario u on x.id = u.id_persona
                inner join tipo_usuario tu on u.id_tipo_usuario = tu.id
                where r.fecha between :p_fecha1 and :p_fecha2 and u.id = :p_usuario
                ";
                $sentencia = $this->dblink->prepare($sql);
