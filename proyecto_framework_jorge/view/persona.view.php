                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body" ><small>
                                                                <div class="form-group" id="div_usuario_sistema">
                                                                ...
                                                                <div class="form-group" >
                                                                    ...
                                                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                                                        <input type="radio" class="flat"
                                                                               id="chbcliente" name="type" style="display: none"
                                                                               value="c" checked=""> Cliente &nbsp;&nbsp;&nbsp;
                                                                        <input type="radio"
                                                                               id="chbtrabajador"  name="type" style="display: none"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                                        <input type="text" maxlength="11"
                                                                               name="txtdni_ruc" onkeypress="return dni_ruc(event);"
                                                                               id="txtdni_ruc" 
                                                                               required=""
                                                                               class="form-control input-sm text-bold">
                                                                    </div>
