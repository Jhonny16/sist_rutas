...
function address() {
    ...
    map_direcciones = new google.maps.Map(document.getElementById('map_direcciones'), {
        center: {lat: -6.7853014, lng: -79.8380569},
        zoom: 13,
        mapTypeId: 'roadmap'
    });
...
function setMapOnAll(map_direcciones) {
    for (var i = 0; i < markers.length; i++) {
        markers[i].setMap(map_direcciones);
    }
    markers = [];
}
